...
// Initialize function
function initializeBuildSan() {
    console.log('Initializing BuildSan system...');
    ...
    function checkDataLoaded() {
        if (!window.COMPONENT_DATA) {
            console.error('Component data not loaded!');
            return false;
        }
        
        if (!window.PC_CONFIGS) {
            console.error('PC configs not loaded!');
            return false;
        }
        ...
        for (const component of requiredComponents) {
            if (!window.COMPONENT_DATA[component]) {
                console.error(`Component data for ${component} is missing!`);
                return false;
            }
        }
    ...
    console.log('All required data loaded:', dataLoaded);
...
window.initializeBuildSan = initializeBuildSan;

// Auto-initialize if all data is already loaded
if (document.readyState === 'complete' || document.readyState === 'interactive') {
    if (window.COMPONENT_DATA && window.PC_CONFIGS) {
        initializeBuildSan();
    }
}